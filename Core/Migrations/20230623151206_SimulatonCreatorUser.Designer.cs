...
namespace Core.Migrations
{
    ...
    [Migration("20230623151206_SimulatonCreatorUser")]
    partial class SimulatonCreatorUser
    {
            ...
            modelBuilder.Entity("Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab4678a5-6e5b-420c-92f3-0b3cdad013cb"),
                            CreateDate = new DateTime(2023, 6, 23, 18, 12, 6, 21, DateTimeKind.Local).AddTicks(9730),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 23, 18, 12, 6, 21, DateTimeKind.Local).AddTicks(9760),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("6bdac0fe-907b-496d-8a63-f1db665fdbf2"),
                            CreateDate = new DateTime(2023, 6, 23, 18, 12, 6, 21, DateTimeKind.Local).AddTicks(9766),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 23, 18, 12, 6, 21, DateTimeKind.Local).AddTicks(9767),
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("71cb82ae-30b4-4b20-98dd-c7f35c457e98"),
                            CreateDate = new DateTime(2023, 6, 23, 18, 12, 6, 21, DateTimeKind.Local).AddTicks(9769),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 23, 18, 12, 6, 21, DateTimeKind.Local).AddTicks(9771),
                            Name = "Developer"
                        });
                });
