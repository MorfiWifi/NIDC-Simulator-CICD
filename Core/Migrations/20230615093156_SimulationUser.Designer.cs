...
namespace Core.Migrations
{
    ...
    [Migration("20230615093156_SimulationUser")]
    partial class SimulationUser
    {
            ...
            modelBuilder.Entity("Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("66958a7d-1f9b-4cfe-83b3-6e63a859c0ab"),
                            CreateDate = new DateTime(2023, 6, 15, 12, 31, 55, 919, DateTimeKind.Local).AddTicks(4146),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 15, 12, 31, 55, 919, DateTimeKind.Local).AddTicks(4179),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("fa52825d-209c-4d64-87f7-60dfa5fae119"),
                            CreateDate = new DateTime(2023, 6, 15, 12, 31, 55, 919, DateTimeKind.Local).AddTicks(4183),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 15, 12, 31, 55, 919, DateTimeKind.Local).AddTicks(4185),
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("3e240e13-e484-4079-bdfe-d183929c65b5"),
                            CreateDate = new DateTime(2023, 6, 15, 12, 31, 55, 919, DateTimeKind.Local).AddTicks(4187),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 15, 12, 31, 55, 919, DateTimeKind.Local).AddTicks(4189),
                            Name = "Developer"
                        });
                });
