...
namespace Core.Migrations
{
    ...
    [Migration("20221217124323_UnitesTemplate")]
    partial class UnitesTemplate
    {
            ...
            modelBuilder.Entity("Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2673c98f-0670-42d3-9a5f-e88ab0acfd73"),
                            CreateDate = new DateTime(2022, 12, 17, 16, 13, 23, 44, DateTimeKind.Local).AddTicks(7039),
                            Deleted = false,
                            ModifyDate = new DateTime(2022, 12, 17, 16, 13, 23, 48, DateTimeKind.Local).AddTicks(6258),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("96afc574-34ee-497e-8968-73a26eab5fc5"),
                            CreateDate = new DateTime(2022, 12, 17, 16, 13, 23, 48, DateTimeKind.Local).AddTicks(7556),
                            Deleted = false,
                            ModifyDate = new DateTime(2022, 12, 17, 16, 13, 23, 48, DateTimeKind.Local).AddTicks(7568),
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("3bd07626-72ae-4ccf-8c77-747197cb655f"),
                            CreateDate = new DateTime(2022, 12, 17, 16, 13, 23, 48, DateTimeKind.Local).AddTicks(7572),
                            Deleted = false,
                            ModifyDate = new DateTime(2022, 12, 17, 16, 13, 23, 48, DateTimeKind.Local).AddTicks(7574),
                            Name = "Developer"
                        });
                });
