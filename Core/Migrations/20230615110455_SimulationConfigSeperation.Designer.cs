...
namespace Core.Migrations
{
    ...
    [Migration("20230615110455_SimulationConfigSeperation")]
    partial class SimulationConfigSeperation
    {
            ...
            modelBuilder.Entity("Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("33d5daf1-bedb-422d-ac60-586488dc9a97"),
                            CreateDate = new DateTime(2023, 6, 15, 14, 4, 55, 553, DateTimeKind.Local).AddTicks(4381),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 15, 14, 4, 55, 553, DateTimeKind.Local).AddTicks(4413),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("72bbed94-078e-4251-8316-d6998dd7c1d4"),
                            CreateDate = new DateTime(2023, 6, 15, 14, 4, 55, 553, DateTimeKind.Local).AddTicks(4418),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 15, 14, 4, 55, 553, DateTimeKind.Local).AddTicks(4419),
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("fa20de09-2618-434f-b425-2cb57e8fcee5"),
                            CreateDate = new DateTime(2023, 6, 15, 14, 4, 55, 553, DateTimeKind.Local).AddTicks(4456),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 6, 15, 14, 4, 55, 553, DateTimeKind.Local).AddTicks(4458),
                            Name = "Developer"
                        });
                });
