...
namespace Core.Migrations
{
    ...
    [Migration("20230815212317_configAccountCascade")]
    partial class configAccountCascade
    {
            ...
            modelBuilder.Entity("Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3fc3a229-6c45-4dc4-8549-2819782fb533"),
                            CreateDate = new DateTime(2023, 8, 16, 0, 23, 17, 505, DateTimeKind.Local).AddTicks(3262),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 8, 16, 0, 23, 17, 505, DateTimeKind.Local).AddTicks(3302),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("d5c8c1a2-5a2b-4b91-b4e0-aaba9d42f11c"),
                            CreateDate = new DateTime(2023, 8, 16, 0, 23, 17, 505, DateTimeKind.Local).AddTicks(3308),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 8, 16, 0, 23, 17, 505, DateTimeKind.Local).AddTicks(3309),
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("42871abf-411e-4792-b468-3b07bcc1ce24"),
                            CreateDate = new DateTime(2023, 8, 16, 0, 23, 17, 505, DateTimeKind.Local).AddTicks(3311),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 8, 16, 0, 23, 17, 505, DateTimeKind.Local).AddTicks(3313),
                            Name = "Developer"
                        });
                });
