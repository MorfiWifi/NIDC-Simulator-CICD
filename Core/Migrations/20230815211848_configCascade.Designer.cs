...
namespace Core.Migrations
{
    ...
    [Migration("20230815211848_configCascade")]
    partial class configCascade
    {
            ...
            modelBuilder.Entity("Domain.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5780ae65-14af-443d-b784-3c385c0e51bb"),
                            CreateDate = new DateTime(2023, 8, 16, 0, 18, 48, 594, DateTimeKind.Local).AddTicks(1978),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 8, 16, 0, 18, 48, 594, DateTimeKind.Local).AddTicks(2012),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("28c14441-4058-4bbf-a237-0a258d443f97"),
                            CreateDate = new DateTime(2023, 8, 16, 0, 18, 48, 594, DateTimeKind.Local).AddTicks(2016),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 8, 16, 0, 18, 48, 594, DateTimeKind.Local).AddTicks(2018),
                            Name = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("19a589bd-be7c-4d0f-aac5-bb7a57cb41d6"),
                            CreateDate = new DateTime(2023, 8, 16, 0, 18, 48, 594, DateTimeKind.Local).AddTicks(2021),
                            Deleted = false,
                            ModifyDate = new DateTime(2023, 8, 16, 0, 18, 48, 594, DateTimeKind.Local).AddTicks(2022),
                            Name = "Developer"
                        });
                });
